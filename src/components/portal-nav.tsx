...
export function PortalNav() {
  return (
    <header className="flex-shrink-0 border-b border-gray-200 bg-white">
        ...
        <div className="mx-auto max-w-7xl px-3 sm:px-4 lg:px-8">
          <div className="flex flex-col gap-2 py-2 min-[425px]:min-h-14 min-[425px]:flex-row min-[425px]:items-center min-[425px]:justify-between min-[425px]:gap-3 min-[425px]:py-0">
            <div className="flex min-w-0 flex-col gap-1 sm:flex-row sm:items-center sm:gap-3">
              ...
              <p className="hidden text-xs text-gray-500 min-[1025px]:block">
                Lieferanten-Tracking · Teil der Kawai Labs Shopverwaltung
              </p>
            </div>
      ...
      <p className="border-t border-gray-100 bg-gray-50 px-3 py-2 text-center text-xs text-gray-600 lg:hidden">
        Teil der Kawai Labs Shopverwaltung
      </p>
    </header>
  );
}
